...
from zenpy.lib.api_objects import DynamicContentItem, Variant
...
def create_dynamic_content_items(csv_file_path):
    ...
    Each item will have variants for the specified locale IDs using the same dc_body field.
    """
    with open(csv_file_path, mode='r', encoding='utf-8') as file:
        ...
        for row in reader:
            ...
            item = DynamicContentItem(
                ...
                variants=[
                    Variant(locale_id=10, content=dc_body),   # Variant for default locale
                    Variant(locale_id=1176, content=dc_body)  # Additional variant for locale ID 1176
                ]
            )
